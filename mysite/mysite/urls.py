...
urlpatterns = [
    ...
    path("a-login/", search_views.alogin, name="alogin"),
    path("a-logout/", search_views.alogout, name="alogout"),
    path("admin-login/", search_views.adminlogin, name="adminlogin"),
    path("admin-home/", search_views.adminhome, name="adminhome"),
    path("pending-details/", search_views.pendingdetails, name="pendingdetails"),
    path("verify/<int:id>", search_views.verify, name="verify"),
    path("remove/<int:id>", search_views.remove, name="remove"),
    ...
    path("national-conferencet/", search_views.nationalconferencest, name='national conferences'),
    path("national-conferences1/", search_views.nationalconferences1, name='national conferences1'),
    path("national-conferences2/", search_views.nationalconferences2, name='national conferences2'),
    path("international-conferencet/", search_views.internationalconferencest, name='international conferences'),
    path("international-conferences1/", search_views.internationalconferences1, name='international conferences1'),
    path("international-conferences2/", search_views.internationalconferences2, name='international conferences2'),
